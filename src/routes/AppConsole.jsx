          ...
          {messages.length === 0 ? (
            <div style={styles.premiumEmptyShell}>
              <OrkioVoiceHero
                ...
                tenant={tenant}
                token={token}
                defaultLocale={String((user?.language || SPEECH_RECOGNITION_LANG || "pt-BR")).toLowerCase().startsWith("en") ? "en-US" : "pt-BR"}
                ...
                <div style={styles.premiumAsideCard}>
                  ...
                  <div style={styles.premiumStatusRow}>
                    ...
                    <div style={styles.premiumStatusCard}>
                      ...
                      <div style={styles.premiumStatusValue}>"Console governado"</div>
                    </div>
                    <div style={styles.premiumStatusCard}>
